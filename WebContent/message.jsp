...
<body>
	...
	<div class="form2"  >	
					<fieldset style="padding:15px;color:#b21212;width:400px; margin:250px 0px 0px 450px;">
						...
						<legend style="color:black;font-size:30px;">Request Confirmation</legend>
						
						
							
						
						<h1 style="color:#56A7E6;">Your request is sent Successfully. Wait sometimes to confirmation from donor.</h1>
						<br><h2 style="color:#FA4616;">Thanku for choosing our Services :)<br> Visit Again.</h2>
